...
public class AdvanceDay7Controller implements Initializable {
    ...
    private void startExercise(ActionEvent event) {
        try {
            //ganti sesuai fxml
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("/view/advanceday7exercise.fxml"));
    ...
    public void initialize(URL url, ResourceBundle rb){
        myQueue.add("1. The Parallel");
        myQueue.add("2. Wide Slopes");
        myQueue.add("3. The Hammer");
        myQueue.add("4. Arms Behind The Head");
        myQueue.add("5. Heel Slides With Knee To Chest");
        myQueue.add("6. Leg Lift 1");
        myQueue.add("7. Leg Lift 2");
        myQueue.add("8. Sideways Head Lift");
        myQueue.add("9. Knee Steps");
