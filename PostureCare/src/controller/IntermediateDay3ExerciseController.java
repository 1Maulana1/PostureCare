...
public class IntermediateDay3ExerciseController implements Initializable {
    private Level level;
    ...
    private void showFinishScene() {
        String savePath = "hasilintermediateday3.xml"; // Ubah
        XMLSaver.savePartialLevel(level, currentExercise, savePath);

        Label finishLabel = new Label("Exercise Day 3 Completed!"); //Ubah
    ...
    public void initialize(URL url, ResourceBundle rb){
        level = XMLLoader.loadLevel(getClass().getResource("/database/intermediateday3.xml").getPath()); //Ubah
