...
public class IntermediateDay4ExerciseController implements Initializable {
    private Level level;
    ...
    private void showFinishScene() {
        String savePath = "hasilintermediateday4.xml"; // Ubah
    ...
    public void initialize(URL url, ResourceBundle rb){
        level = XMLLoader.loadLevel(getClass().getResource("/database/intermediateday4.xml").getPath()); //Ubah
