...
public class AdvanceController implements Initializable {
    ...
    private void keDay1(ActionEvent event){
        ...
        Pane halaman = object.getPane("advanceday1");
    ...
    private void keDay2(ActionEvent event){
        OpenSceneLevel object = new OpenSceneLevel();
        Pane halaman = object.getPane("advanceday2");
        mainPane.setLeft(halaman);
    }
    ...
    private void keDay3(ActionEvent event){
        OpenSceneLevel object = new OpenSceneLevel();
        Pane halaman = object.getPane("advanceday3");
        mainPane.setLeft(halaman);
    }
    ...
    private void keDay4(ActionEvent event){
        OpenSceneLevel object = new OpenSceneLevel();
        Pane halaman = object.getPane("advanceday4");
        mainPane.setLeft(halaman);
    }
    ...
    private void keDay5(ActionEvent event){
        OpenSceneLevel object = new OpenSceneLevel();
        Pane halaman = object.getPane("advanceday5");
        mainPane.setLeft(halaman);
    }
    ...
    private void keDay6(ActionEvent event){
        OpenSceneLevel object = new OpenSceneLevel();
        Pane halaman = object.getPane("advanceday6");
        mainPane.setLeft(halaman);
    }
    ...
    private void keDay7(ActionEvent event){
        OpenSceneLevel object = new OpenSceneLevel();
        Pane halaman = object.getPane("advanceday7");
        mainPane.setLeft(halaman);
    }
