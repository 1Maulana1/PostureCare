...
public class IntermediateDay5ExerciseController implements Initializable {
    private Level level;
    ...
    private void showFinishScene() {
        String savePath = "hasilintermediateday5.xml"; // Ubah
        XMLSaver.savePartialLevel(level, currentExercise, savePath);

        Label finishLabel = new Label("Exercise Day 5 Completed!"); //Ubah
    ...
    public void initialize(URL url, ResourceBundle rb){
        level = XMLLoader.loadLevel(getClass().getResource("/database/intermediateday5.xml").getPath()); //Ubah
