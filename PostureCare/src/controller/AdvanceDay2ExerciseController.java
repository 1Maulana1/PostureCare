...
public class AdvanceDay2ExerciseController implements Initializable {
    private Level level;
    ...
    private void showFinishScene() {
        String savePath = "hasiladvanceday2.xml"; // Ubah
    ...
    public void initialize(URL url, ResourceBundle rb){
        level = XMLLoader.loadLevel(getClass().getResource("/database/advanceday2.xml").getPath()); //Ubah
