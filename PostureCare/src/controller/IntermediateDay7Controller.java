...
public class IntermediateDay7Controller implements Initializable {
    ...
    private void startExercise(ActionEvent event) {
        try {
            //ganti sesuai fxml
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("/view/intermediateday7exercise.fxml"));
