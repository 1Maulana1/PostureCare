...
public class IntermediateDay2ExerciseController implements Initializable {
    private Level level;
    ...
    private void showFinishScene() {
        String savePath = "hasilintermediateday2.xml"; // Ubah
        XMLSaver.savePartialLevel(level, currentExercise, savePath);

        Label finishLabel = new Label("Exercise Day 2 Completed!"); //Ubah
    ...
    public void initialize(URL url, ResourceBundle rb){
        level = XMLLoader.loadLevel(getClass().getResource("/database/intermediateday2.xml").getPath()); //Ubah
