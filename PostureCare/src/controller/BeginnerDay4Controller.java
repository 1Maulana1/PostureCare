...
public class BeginnerDay4Controller implements Initializable {
    ...
    private void startExercise(ActionEvent event) {
        try {
            //ganti sesuai fxml
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("/view/beginnerday4exercise.fxml"));
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        myQueue.add("2. Twisting crunches");
        myQueue.add("3. Baby pose");
        myQueue.add("4. Arm behind the head");
        myQueue.add("5. Cat 1");
        myQueue.add("6. Cat 2");
