...
public class BeginnerDay3Controller implements Initializable {
    ...
    private void startExercise(ActionEvent event) {
        try {
            //ganti sesuai fxml
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("/view/beginnerday3exercise.fxml"));
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        myQueue.add("4. Heel slides");
        myQueue.add("5. Heel slides with knee to chest");
        myQueue.add("6. Table");
        myQueue.add("7. Short plank");
        myQueue.add("8. Squat to heel");
