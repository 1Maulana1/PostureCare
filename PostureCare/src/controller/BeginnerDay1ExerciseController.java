...
public class BeginnerDay1ExerciseController implements Initializable {
    private Level level;
    ...
    private void showFinishScene() {
        String savePath = "hasilbeginnerday1.xml"; // Ubah
    ...
    public void initialize(URL url, ResourceBundle rb){
        level = XMLLoader.loadLevel(getClass().getResource("/database/beginnerday1.xml").getPath()); //Ubah
