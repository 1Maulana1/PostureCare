...
public class BeginnerDay5Controller implements Initializable {
    ...
    private void startExercise(ActionEvent event) {
        try {
            //ganti sesuai fxml
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("/view/beginnerday5exercise.fxml"));
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        myQueue.add("3. Lying arm circle");
        myQueue.add("4. Hold the lotus");
        myQueue.add("5. Leg lift");
        myQueue.add("6. Both leg lift");
        myQueue.add("7. Dead bug");
        myQueue.add("8. Toes to the knee");
