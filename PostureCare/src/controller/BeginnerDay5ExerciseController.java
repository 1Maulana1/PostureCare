...
public class BeginnerDay5ExerciseController implements Initializable {
    private Level level;
    ...
    private void showFinishScene() {
        String savePath = "hasilbeginnerday5.xml"; // Ubah
        XMLSaver.savePartialLevel(level, currentExercise, savePath);

        Label finishLabel = new Label("Exercise Day 5 Completed!");
    ...
    public void initialize(URL url, ResourceBundle rb){
        level = XMLLoader.loadLevel(getClass().getResource("/database/beginnerday5.xml").getPath()); //Ubah
